            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" >
                    ...
                    <div class="carousel-item active" style="height: 600px;">
                        <img class="img-fluid" src="{{asset('shop/img/shop.jpg')}}" alt="Image">
                    ...
                    <div class="carousel-item" style="height: 600px;">
                        <img class="img-fluid" src="{{asset('shop/img/shop2.jpg')}}" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <!-- <h4 class="text-light text-uppercase font-weight-medium mb-3">GIẢM 10% ĐƠN HÀNG ĐẦU TIÊN</h4>
                    ...
                    <div class="carousel-item" style="height: 600px;">
                        <img class="img-fluid" src="{{asset('shop/img/shop3.jpg')}}" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <!-- <h4 class="text-light text-uppercase font-weight-medium mb-3">GIẢM 10% ĐƠN HÀNG ĐẦU TIÊN</h4>
