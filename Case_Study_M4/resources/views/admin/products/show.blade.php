            ...
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div style=" margin-top: 24px;" class="main_image"> <img src="{{ asset($productshow->image)}}" id="main_product_image" height="700" width="412">
                        </div><br>
                    </div>
                </div>
                <div class="col-md-6">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Trạng thái: </td>
                                                <td>{{ $productshow->status == 0 ? ' Còn Hàng' : 'Hết Hàng' }}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>Các size: </td>
                                                <td>
                                                    @foreach($productshow->sizes as $size)
                                                        {{ $size->name }},
                                                    @endforeach
                                                </td>
                                            </tr>
